    ...
    public function processRequestForEvents()
        {
            switch($this->requestMethod)
            {
                case 'GET':
                    ...
                    {
                        $useritm = array('event_srno' => $res['event_srno'], 'event_name' => $res['event_name'], 'event_date' => $res['event_date'], 'event_time' => $res['event_time'], 'event_location' => $res['event_location'], 'event_fee' => $res['event_fee'], 'event_status' => $res['event_status']);
