...
<?php
    class events
    {
        ...
        public function insertEvent($arr)
        {
            ...
            $sql = "INSERT INTO `events` (`event_srno`, `event_name`, `event_date`, `event_time`, `event_location`, `event_fee`, `event_status`) VALUES (NULL, '$this->event_name', '$this->event_date', '$this->event_time', '$this->event_location', '$this->event_fee', '$this->event_status');";
        ...
        public function updateEvent($arr)
        {
            ...
            $this->event_fee = $arr['event_fee'];
            $this->event_status = $arr['event_status'];
            $sql = "update events set event_name = '$this->event_name', event_date = '$this->event_date', event_time = '$this->event_time', event_location = '$this->event_location', event_fee = '$this->event_fee', event_status = '$this->event_status' where event_srno = '$this->event_srno';";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute();
            http_response_code(201);
        }
